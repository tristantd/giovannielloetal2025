...
# Fit the model
model = ols('PressRate ~ C(Day) * C(Group)', data=df_1h).fit()

# Type III SS (like SPSS/JAMOVI/JASP)
rmanova = sm.stats.anova_lm(model, typ=3)
...
Analyses for reproduced original data and simulation data are in code block above. We cannot input only the analyses and figures here because they require all lines of code (e.g., imports, csv, etc).
